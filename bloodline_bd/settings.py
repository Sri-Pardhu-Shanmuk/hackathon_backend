"""
Django settings for bloodline_bd project.
...
SECRET_KEY = 'django-insecure-bw%b_@gml+*or-9+@kt49)wqyl0ab_bfv_ixswvj-2#_cz$wj9'
...
ROOT_URLCONF = 'bloodline_bd.urls'
...
WSGI_APPLICATION = 'bloodline_bd.wsgi.application'
